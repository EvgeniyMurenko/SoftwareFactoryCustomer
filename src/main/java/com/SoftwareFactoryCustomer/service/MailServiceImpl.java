...
public class MailServiceImpl implements MailService {
    ...
    private String mailHeader = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"\n" +
    ...
    private String mailFooter =  "        <p>No need to reply to this email.</p>\n" +
            "\n" +
            "    </div>\n" +
            "    <!-- #End Content -->\n" +
            "\n" +
       ...
       try {
           mailSender.send(new MimeMessagePreparator() {
               ...
               public void prepare(MimeMessage mimeMessage) throws Exception {
                   ...
                   mimeMessage.setContent(mailHeader+"\n"+
                           "        <p>"+respondText+"</p>\n" +
                          mailFooter, "text/html; charset=utf-8");
